...
Déplacer le dossier <sub>Quests/quests</sub> dans le dossier <sub>plugins</sub> de votre serveur Minecraft (Vous devez avoir le plugin Quests d'installé)<br>
Déplacer le fichier <sub>config.sk</sub> et <sub>fichiers.sk</sub> dans le dossier <sub>plugins/Skript/scripts</sub><br>
